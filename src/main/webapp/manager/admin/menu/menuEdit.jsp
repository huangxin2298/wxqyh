        ...
        <form action="" method="post" id="menuForm" onsubmit="return false;"class="form new_form">
            <div class="form-item">
                ...
                <div class="form-field">
                    <input type="text" name="menuName" placeholder="菜单名" id="menuName" class="form-text input-text" readonly>
                </div>
            </div>
            <div class="form-item">
                <div class="title">
...
<script>
    ...
    function getMenuInfo() {
        $.ajax({
            url: "${baseURL}/manager/admin/getAdminMenuInfo.action",
            type: "GET",
            async: false,
            ...
            success: function (result) {
                if (result.code == "0") {
                    ...
                    if(typeof (menuInfo)!="undefined" && menuInfo!=null){
                        ...
                        $("#showOrder").val(menuInfo.showOrder);
                    }else{
                        alert("获取菜单信息失败，请刷新重试");
                    }
                } else {
    ...
    function publish(){
        ...
        $.ajax({
            url: "${baseURL}/manager/admin/updateMenuInfo.action",
            type: "POST",
            data: form,
            async: false,
            dataType: "json",
