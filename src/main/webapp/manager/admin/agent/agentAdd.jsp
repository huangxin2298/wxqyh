    ...
    <div class="cMain">
        <form action="" method="post" id="agentForm" onsubmit="return false;"class="form new_form">
            ...
            <div class="form-item">
                ...
                <div class="form-field">
                    <input type="text" name="agentCode" placeholder="应用code" id="agentCode" class="form-text input-text">
                </div>
            </div>
            <div class="form-item">
                <div class="title">
...
<script>
    function publish(){
        ...
        $.ajax({
            url: "${baseURL}/manager/admin/addAgentInfo.action",
            type: "POST",
            data: form,
            async: false,
            dataType: "json",
