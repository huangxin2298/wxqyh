    ...
    <div class="cMain">
        <form action="" method="post" id="userForm" onsubmit="return false;"class="form new_form">
            ...
            <div class="form-item">
                ...
                <div class="form-field">
                    <input  class="form-text input-text" id="mobile" name="mobile" readonly>
                </div>
            </div>
            <div class="form-item">
                <div class="title">
...
<script>
    ...
    function getUserList() {
        $.ajax({
            url: "${baseURL}/manager/addressbook/getUserDetailById.action",
            type: "POST",
            async: false,
            ...
            success: function (result) {
                if (result.code == "0") {
                    ...
                    if(typeof (userInfo)!="undefined" && userInfo!=null){
                        ...
                        $("#deptId").html("<option value=\""+userInfo.deptId+"\">"+userInfo.deptName+"</option>");
    ...
    function publish(){
        ...
        $.ajax({
            url: "${baseURL}/manager/addressbook/updateUserInfo.action",
            type: "POST",
            data: form,
            async: false,
            dataType: "json",
